...
update VACCINATIONS set vaccination_center=NULL where second_dose='FALSE';
...
--erotime v
SELECT first_dose_date,second_dose_date, COUNT(first_dose_date) proti,COUNT(second_dose_date) deuteri
FROM vaccinations
GROUP BY first_dose_date,second_dose_date;

SELECT second_dose_date, COUNT(second_dose_date) 
